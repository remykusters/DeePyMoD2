...
for run_idx in np.arange(n_runs):
    ...
    train_split_full(model, X, y, optimizer, sparsity_scheduler, split=0.8, log_dir=f'data/grad_run_{run_idx}/', write_iterations=25, max_iterations=5000, delta=0.00, patience=200) # Running
