...
for noise_level in noise:
    for run in np.arange(n_runs):
        ...
        train_split_full(model, X, y, optimizer, sparsity_scheduler, split=0.8, test='full', log_dir=f'data_delta_lam_1e-4/noise_{noise_level}_run_{run}', write_iterations=25, max_iterations=20000, delta=0.001, patience=20) # Running
